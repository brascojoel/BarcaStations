 ...
 */
public class FullCityActivity extends AppCompatActivity implements GoogleMap.OnMarkerClickListener, OnMapReadyCallback {
    /**
    ...
    private List<Station> listStations; private GoogleMap map;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_full_city);

        mVisible = true;
        mControlsView = findViewById(R.id.fullscreen_content_controls);
        mContentView = (MapView)findViewById(R.id.fullscreen_content);


        mViewModel = new ViewModelProvider(this).get(MapViewModel.class);

        mViewModel.getAllStations().observe(this, new Observer<List<Station>>() {
            @Override
            public void onChanged(List<Station> stations) {
                ...
                if(listStations != null){
                    if(mContentView != null){
                        mContentView.onCreate(null);
                        mContentView.onResume();
                        mContentView.getMapAsync(FullCityActivity.this::onMapReady);
    ...
    public void stationOnMap(GoogleMap map){
        ...
        for (Station station : listStations) {
            ...
            //map.setLatLngBoundsForCameraTarget(latLng);
            mMarkerMap.put(marker,station);
        }


        // 41.3985182,2.1917991
